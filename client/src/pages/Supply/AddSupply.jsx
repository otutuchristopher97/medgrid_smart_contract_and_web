...
const AddDrug = () => {
  ...
  const [parameterData, setParameterData] = useState([defaultIngredientState]);
  ...
  return (
    <>
      <Banner title="Request Medication Supply" />
                            ...
                            <div className="row">
                              ...
                              <div className="row mb-6">
                                <h5
                                  ...
                                  style={{ borderBottom: "2px solid #fff" }}
                                >
                                  Describe Medication Quantity and Amount
                                </h5>
                                <div className="col-6 colxs-12">
                                  <Input
                                    type="number"
